	        ...
	        <div class="mobile__content">
	            ...
	            <div class="mobile__navigation">
	                <ul class="mobile__nav">
	                    <li class="mobile__children"><a href="${env }/customer/index.html" class="mobile__link">Trang chủ</li>
	                    <li class="mobile__children">
	                        <a href="#" class="mobile__link">Thú cưng
	                            <i class='bx bx-chevron-down'></i>
	                        </a>
	                        <ul class="mobile__submenu">
	                            <li class="mobile__submenu-item"><a href="${env }/customer/danhmuc.html"
	                    ...
	                    <li class="mobile__children"><a href="${env }/customer/lienhe.html" class="mobile__link">Liên hệ </a></li>
	                </ul>
	            </div>
	        </div>
	    </div>
