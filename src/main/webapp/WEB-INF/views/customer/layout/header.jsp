			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-6">
					<div class="header__bottom-logo">
						<a href="#"><img src="${env }/customer/img/logo.jpg"
				...
				<div class="col-lg-6 block none">
					<div class="header__bottom-menu">
						<ul>
							...
							<li class="header__bottom-menu-children"><a
								...
								<ul class="mega__subnav">
									...
									<li class="mega__subnav-menu">
										...
										<ul class="mega__subnav-menu-2">
											<li><a href="${env }/customer/danhmuc.html">Mèo Anh
													(Dài + Ngắn)</a></li>
											<li><a href="${env }/customer/danhmuc.html">Mèo
													Chân Ngắn</a></li>
											<li><a href="${env }/customer/danhmuc.html">Mèo Tai
													Cụp</a></li>
											<li><a href="${env }/customer/danhmuc.html">Mèo
													Xiêm</a></li>
											<li><a href="${env }/customer/danhmuc.html">Mèo Ba
													Tư</a></li>
											<li><a href="${env }/customer/danhmuc.html">Mèo
													Chinchilla</a></li>
										</ul>
							...
							<li class="header__bottom-menu-children"><a
								href="${env }/customer/lienhe.html">Liên hệ</a></li>
						</ul>
					</div>
				</div>
								...
								<div class="header__bottom-box-cart">
									<div class="header__cart-products">
										<div class="cart-product-inner">
											<div class="cart-product__main">
												<div class="cart-product__thumb">
													<img src="${env }/customer/img/products/3.jpg"
														class="cart-product-img">
												</div>
												<div class="cart-product__content">
													<a href="${env }/cart-view">
										...
										<div class="cart-product-inner">
											<div class="cart-product__main">
												<div class="cart-product__thumb">
													<img src="${env }/customer/img/products/1.jpg"
														class="cart-product-img">
												</div>
												<div class="cart-product__content">
													<a href="${env }/customer/sanpham.html">
									...
									<div class="header__cart-product-buy">
										<a href="${env }/cart-view" class="buy-product">Mua hàng</a>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="swiper mySwiper ">
			<div class="swiper-wrapper">
				<div class="swiper-slide .header__slider-imgs">
					<img src="${env }/customer/img/slider-1.jpg" alt=""
						class="header__slider-img">
				</div>
				<div class="swiper-slide .header__slider-imgs">
					<img src="${env }/customer/img/slider-2.jpg" alt=""
						class="header__slider-img">
				</div>
				<div class="swiper-slide .header__slider-imgs">
					<img src="${env }/customer/img/slider-3.jpg" alt=""
						class="header__slider-img">
				</div>
				<div class="swiper-slide .header__slider-imgs">
					<img src="${env }/customer/img/slider-4.jpg" alt=""
						class="header__slider-img">
				</div>
			</div>
