            ...
            <div class="main__breadcrumb">
                <div class="container">
                    <div class="bread-crumb">
                        <span><a href="${env }/index">Trang chủ</a></span>
                        <span><a href="${env }/category">Danh mục sản phẩm</a></span>
                        <span><a href="${env }/product">Sản phẩm</a></span>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="swiper-wrapper">
                                                    <c:forEach items="${product.productImages }" var="image">
	                                                    <div class="swiper-slide">
	                                                        <img src="${env }/UploadFiles/${image.path }" alt="click here"
