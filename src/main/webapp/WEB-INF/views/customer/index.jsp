		...
		<main class="main">
					...
					<div class="main__products-content">
						<div class="row">
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="${env }/customer/sanpham.html" class="image"> <img
											src="${env }/customer/img/products/1.jpg"
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="${env }/customer/sanpham.html" class="image"> <img
											src="${env }/customer/img/products/4.jpg"
											class="fit-img zoom-img">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="${env }/customer/sanpham.html" class="image"> <img
											src="${env }/customer/img/products/2.jpeg"
											class="fit-img zoom-img">
										</a> <span class="badges"> <!-- <span class="sale">-20%</span> -->
										</span>
									</div>
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="${env }/customer/sanpham.html" class="image"> <img
											src="${env }/customer/img/products/7.jpg"
											class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-20%</span>
										</span>
									</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-6">
							<a href="${env }/customer/danhmuc.html" class="banner-sale">
								<img src="${env }/customer/img/oder-1.jpg" alt="">
							</a>
						</div>
						<div class="col-12 col-lg-6 block none">
							<a href="${env }/customer/danhmuc.html" class="banner-sale">
								<img src="${env }/customer/img/oder-2.jpg" alt="">
							</a>
						</div>
					</div>
				</div>
			...
			<div class="main__products">
				<div class="container">
						...
						<div class="row">
							<c:forEach items="${products }" var="product">
								<div class="col-12 col-lg-3 col-md-6">
									<div class="product">
										<div class="thumb">
											<a href="${env }/product/${product.id }" class="image"> <img
										...
										<div class="content">
											<a href="${env }/product/${product.id }" class="content-link">
												...
												<a href=""><i class='bx bx-heart'></i></a> 
												<button type="button" onclick="addToCart(${product.id },1, ${product.price } ,'${product.name }', '${product.avatar }')"><i
													class='bx bx-cart'></i>
												</button>
											</span>
										</div>
					...
					<div class="main__products-more">
						<a href="${env }/customer/danhmuc.html">Xem thêm</a>
					</div>
				</div>
			</div>
			<!-- Danh sách phụ kiện -->
						...
						<div class="row">
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="${env }/customer/sanpham.html" class="image"> <img
											src="${env }/customer/img/products/phukien/1.jpg"
											class="fit-img zoom-img">
										</a>
										<!-- <span class="badges">
                                            <span class="sale">-20%</span>
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="${env }/customer/sanpham.html" class="image"> <img
											src="${env }/customer/img/products/phukien/4.jpg"
											class="fit-img zoom-img">
										</a> <span class="badges"> <span class="new">new</span>
										</span>
									</div>
					...
					<div class="row">
						...
						<div class="col-12 col-lg-4 col-md-6">
							<div class="product">
								<div class="thumb">
									<a href="${env }/customer/sanpham.html" class="image"> <img
										src="${env }/customer/img/products/1.jpeg"
						...
						<div class="col-12 col-lg-4 col-md-6">
							<div class="product">
								<div class="thumb">
									<a href="${env }/customer/sanpham.html" class="image"> <img
										src="${env }/customer/img/products/2.jpg"
										class="fit-img opacity-img">
									</a>
								</div>
								<div class="content">
						...
						<div class="col-12 col-lg-4 col-md-6">
							<div class="product">
								<div class="thumb">
									<a href="${env }/customer/sanpham.html" class="image"> <img
										src="${env }/customer/img/products/6.jpeg"
										class="fit-img opacity-img">
									</a>
								</div>
								<div class="content">
