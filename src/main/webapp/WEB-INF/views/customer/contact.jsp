	                                    ...
	                                    <div class="row">
	                                        ...
	                                        <div class="col-md-6">
	                                            <div class="contact__form-input">
	                                                <input id = "name" name = "name" type="text" class="form-input" placeholder="Your name...">
	                                            </div>
	                                        </div>
	                                        <div class="col-md-6">
	                                            <div class="contact__form-input">
											...
											<div class="col-md-6">
											    <div class="contact__form-input">
											        <input id = "address" name = "address" type="text" class="form-input" placeholder="Your address...">
											    </div>
											</div>
											<div class="col-md-6">
											    <div class="contact__form-input">
