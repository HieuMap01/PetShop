	                        ...
	                        <div class="col-12 col-lg-6">
	                            ...
	                            <div class="contact__form">
									...
									<c:if test="${not empty toast}">
									  <div class="alert ${toastType=='success' ? 'alert-success' : 'alert-danger'}" id="page-toast">
									    ${toast}
									  </div>
									  <script>
									    setTimeout(()=>{ const t=document.getElementById('page-toast'); if(t) t.style.display='none'; }, 3000);
									  </script>
									</c:if>

	                                <sf:form class="form" action = "/contact/save-sf-edit" method = "post" 
	                                    ...
	                                    <div class="row">
	                                        ...
	                                        <div class="col-md-6">
	                                            <div class="contact__form-input">
	                                                <sf:input path="name" id = "name" name = "name" type="text" class="form-input" placeholder="Your name..."/>
	                                            </div>
	                                        </div>
	                                        <div class="col-md-6">
	                                            <div class="contact__form-input">
	                                                <sf:input path="email" id = "email" name = "email" type="email" class="form-input" placeholder="Email..."/>
	                                            </div>
	                                        </div>
											
											<div class="col-md-6">
											    <div class="contact__form-input">
											        <sf:input path="address" id = "address" name = "address" type="text" class="form-input" placeholder="Your address..."/>
											    </div>
											</div>
											<div class="col-md-6">
											    <div class="contact__form-input">
											        <sf:input path="mobile" id = "mobile" name = "mobile" type="text" class="form-input" placeholder="Mobile..."/>
											    </div>
											</div>
											
	                                        <div class="col-12">
	                                            <div class="contact__form-input">
	                                                <sf:textarea path="message" cols="30" rows="5" class="form__textarea" id = "message" name="message" placeholder="Message"/>
	                                            </div>
	                                        </div>
											<div class="col-12">
											    <div class="contact__form-input">
	                                        ...
	                                        <div class="col-12">
	                                            <div class="contact__btn">
	                                                <sf:button type="submit" class="btn btn-primary">Send</a></sf:button>
	                                            </div>
	                                        </div>
	                                    </div>
	                                </sf:form>
