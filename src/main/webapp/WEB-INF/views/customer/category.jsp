                            ...
                            <div class="row section__shop-wrapper">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="${env }/customer/sanpham.html" class="image">
                                                <img src="${env }/customer/img/products/1.jpg" class="fit-img zoom-img">
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-lg-4 col-md-6">
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="${env }/customer/sanpham.html" class="image">
                                                <img src="${env }/customer/img/products/3.jpeg" class="fit-img zoom-img">
                                            </a>
                                            <span class="badges">
                                                <!-- <span class="sale">-20%</span> -->
                                ...
                                <div class="col-12 col-lg-4 col-md-6">
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="${env }/customer/sanpham.html" class="image">
                                                <img src="${env }/customer/img/products/7.jpeg" class="fit-img zoom-img">
                                            </a>
                                            <span class="badges">
                                                <span class="sale">-20%</span>
                                            </span>
